...
public class PathUtil {
	...
	public static String getFtlPath(){
		return System.getProperty("user.dir")+"\\src\\main\\java\\com\\zyx\\util\\ftl\\";
	}
	
	public static String getControllerPath(){
		return System.getProperty("user.dir")+"\\src\\main\\java\\com\\zyx\\web\\";
	}
	
	public static String getServicePath(){
		return System.getProperty("user.dir")+"\\src\\main\\java\\com\\zyx\\service\\";
	}
	
	public static String getHtmlPath(){
		return System.getProperty("user.dir")+"\\src\\main\\resources\\templates\\";
	}
