...
public class LocationService {
	...
	public List<Map<String, Object>> getMarkers() throws Exception{
		List<Map<String, Object>> list = (List<Map<String, Object>>) dao.findForList("com.zyx.mapper.LocationMapper.getMarkers", "");
		return list;
	}
	
	public boolean save(PageData pd) throws Exception {
		int count = dao.save("com.zyx.mapper.LocationMapper.save", pd);
		if(count == 1){
			return true;
		}else{
			return false;
